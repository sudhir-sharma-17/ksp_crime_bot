...
import { Database, FileDown, Layers, LineChart, Maximize2, Minimize2, Columns2, PanelRightOpen } from 'lucide-react';
...
export default function DataCanvas({
  ...
  return (
    <section className="flex-1 bg-white dark:bg-slate-900 flex flex-col relative overflow-hidden transition-colors duration-200 h-full">
      {/* Canvas Top Bar */}
      <div className="h-14 sm:h-16 bg-slate-50 dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800 flex items-center justify-between px-4 sm:px-6 shrink-0 transition-colors gap-2 select-none">
        <div className="flex items-center gap-2 sm:gap-2.5">
          <Database className="w-4 h-4 text-blue-600 dark:text-cyan-400 shrink-0" />
          <div className="flex items-center gap-2">
            ...
            {activeDataIndex !== null && (
              <span className="text-[10px] font-mono font-bold text-slate-500 dark:text-slate-400 bg-slate-200 dark:bg-slate-800 px-2 py-0.5 rounded-full shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="hidden lg:flex items-center bg-slate-100 dark:bg-slate-800 p-0.5 rounded-lg border border-slate-200 dark:border-slate-700/80 text-[11px] font-mono text-slate-600 dark:text-slate-300">
            <button
              type="button"
              onClick={() => onSetPreset?.('default')}
              className="px-2 py-1 rounded hover:bg-white dark:hover:bg-slate-700 transition-colors"
            ...
            <button
              ...
              className="px-2 py-1 rounded hover:bg-white dark:hover:bg-slate-700 transition-colors font-bold text-blue-600 dark:text-cyan-400"
          ...
          <button
            ...
            className="p-1.5 sm:p-2 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-600 dark:text-slate-300 hover:bg-slate-200 dark:hover:bg-slate-700 border border-slate-200 dark:border-slate-700/80 transition-colors cursor-pointer"
          ...
          {hasResults && (
            <button 
              type="button"
              onClick={exportToPDF} 
              className="flex items-center gap-1.5 bg-blue-900 hover:bg-blue-800 dark:bg-blue-800 dark:hover:bg-blue-700 text-white px-3 py-1.5 sm:py-2 rounded-xl text-xs font-bold shadow-xs transition-colors cursor-pointer shrink-0"
      ...
      <div className="flex-1 overflow-y-auto p-4 sm:p-6 bg-slate-100/70 dark:bg-slate-950 transition-colors">
        {!hasResults ? (
