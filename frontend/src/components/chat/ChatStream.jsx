...
export default function ChatStream({
  ...
  return (
    <>
      <section 
        className="bg-slate-50 dark:bg-slate-950 flex flex-col relative border-r border-slate-200 dark:border-slate-800/80 shrink-0 transition-colors duration-300 overflow-hidden h-full"
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-5 space-y-3">
          ...
          {isFreshSession && (
            <div className="flex flex-col items-center justify-center py-6 px-2 text-center animate-fade-in">
              <div className="w-16 h-16 rounded-2xl bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 flex items-center justify-center shadow-md mb-4 p-2.5">
                <img 
                ...
                {SUGGESTIONS.map((item, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className="p-3.5 rounded-xl bg-white dark:bg-slate-900 hover:bg-blue-50/60 dark:hover:bg-slate-800/80 border border-slate-200 dark:border-slate-800 hover:border-blue-400 dark:hover:border-slate-700 shadow-xs transition-all text-left cursor-pointer group"
                    >
          ...
          {isLoading && (
            <div className="flex items-center justify-between p-4 rounded-2xl bg-blue-50/90 dark:bg-slate-900 border border-blue-200 dark:border-slate-800 shadow-sm animate-fade-in mb-3">
