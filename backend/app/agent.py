...
async def generate_sql_node(state: State) -> State:
    ...
    system_prompt = (
        ...
        "Core Schema:\n"
        "- CaseMaster (CaseMasterID, CrimeNo, CaseNo, CrimeRegisteredDate, PolicePersonID, PoliceStationID, CaseCategoryID, GravityOffenceID, CaseStatusID, BriefFacts)\n"
        ...
        "- Employee (EmployeeID, FirstName, KGID, RankID, UnitID)\n"
        "- ChargesheetDetails (CSID, CaseMasterID, csdate, cstype)\n"
        "Always join tables using CaseMasterID where applicable.\n\n"
